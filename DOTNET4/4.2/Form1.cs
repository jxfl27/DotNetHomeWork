...
namespace Store
{
    ...
    {
        static readonly GoodsList pl = new GoodsList();
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            orderLineDetailBindingSource.DataSource = os.Orders[e.RowIndex].Od.Entries;
        ...
        private void RemoveOrderButton_Click(object sender, EventArgs e)
        {
            ...
            {
                os.Orders.Remove(os.Orders[currentIndex]);
                orderBindingSource.ResetBindings(true);
            }
